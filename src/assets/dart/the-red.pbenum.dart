...
class MessageID extends $pb.ProtobufEnum {
  ...
  static const MessageID BATTERY_LEVEL = MessageID._(10, _omitEnumNames ? '' : 'BATTERY_LEVEL');
  static const MessageID CURRENT_KNOB_SELECTED = MessageID._(11, _omitEnumNames ? '' : 'CURRENT_KNOB_SELECTED');
  static const MessageID SELECT_GATE = MessageID._(12, _omitEnumNames ? '' : 'SELECT_GATE');
  static const MessageID SELECT_EFX = MessageID._(13, _omitEnumNames ? '' : 'SELECT_EFX');
  static const MessageID SELECT_AMP = MessageID._(14, _omitEnumNames ? '' : 'SELECT_AMP');
  static const MessageID SELECT_CAB = MessageID._(15, _omitEnumNames ? '' : 'SELECT_CAB');
  static const MessageID SELECT_MOD = MessageID._(16, _omitEnumNames ? '' : 'SELECT_MOD');
  static const MessageID SELECT_DELAY = MessageID._(17, _omitEnumNames ? '' : 'SELECT_DELAY');
  static const MessageID SELECT_REVERB = MessageID._(18, _omitEnumNames ? '' : 'SELECT_REVERB');
  static const MessageID PARAM_GATE = MessageID._(19, _omitEnumNames ? '' : 'PARAM_GATE');
  static const MessageID PARAM_EFX_OVERDRIVE = MessageID._(20, _omitEnumNames ? '' : 'PARAM_EFX_OVERDRIVE');
  static const MessageID PARAM_EFX_DISTORTION = MessageID._(21, _omitEnumNames ? '' : 'PARAM_EFX_DISTORTION');
  static const MessageID PARAM_EFX_FUZZ = MessageID._(22, _omitEnumNames ? '' : 'PARAM_EFX_FUZZ');
  static const MessageID PARAM_EFX_ACOUSTIC = MessageID._(23, _omitEnumNames ? '' : 'PARAM_EFX_ACOUSTIC');
  static const MessageID PARAM_AMP_F = MessageID._(24, _omitEnumNames ? '' : 'PARAM_AMP_F');
  static const MessageID PARAM_AMP_MA = MessageID._(25, _omitEnumNames ? '' : 'PARAM_AMP_MA');
  static const MessageID PARAM_AMP_ME = MessageID._(26, _omitEnumNames ? '' : 'PARAM_AMP_ME');
  static const MessageID PARAM_AMP_V = MessageID._(27, _omitEnumNames ? '' : 'PARAM_AMP_V');
  static const MessageID PARAM_AMP_B = MessageID._(28, _omitEnumNames ? '' : 'PARAM_AMP_B');
  static const MessageID PARAM_CAB_A = MessageID._(29, _omitEnumNames ? '' : 'PARAM_CAB_A');
  static const MessageID PARAM_CAB_B = MessageID._(30, _omitEnumNames ? '' : 'PARAM_CAB_B');
  static const MessageID PARAM_CAB_C = MessageID._(31, _omitEnumNames ? '' : 'PARAM_CAB_C');
  static const MessageID PARAM_CAB_D = MessageID._(32, _omitEnumNames ? '' : 'PARAM_CAB_D');
  static const MessageID PARAM_CAB_E = MessageID._(33, _omitEnumNames ? '' : 'PARAM_CAB_E');
  static const MessageID PARAM_MOD_FLANGE = MessageID._(34, _omitEnumNames ? '' : 'PARAM_MOD_FLANGE');
  static const MessageID PARAM_MOD_CHORUS = MessageID._(35, _omitEnumNames ? '' : 'PARAM_MOD_CHORUS');
  static const MessageID PARAM_MOD_TREMOLO = MessageID._(36, _omitEnumNames ? '' : 'PARAM_MOD_TREMOLO');
  static const MessageID PARAM_MOD_PHASER = MessageID._(37, _omitEnumNames ? '' : 'PARAM_MOD_PHASER');
  static const MessageID PARAM_MOD_VIBRATO = MessageID._(38, _omitEnumNames ? '' : 'PARAM_MOD_VIBRATO');
  static const MessageID PARAM_DELAY_DELAY = MessageID._(39, _omitEnumNames ? '' : 'PARAM_DELAY_DELAY');
  static const MessageID PARAM_REVERB_ROOM = MessageID._(40, _omitEnumNames ? '' : 'PARAM_REVERB_ROOM');
  static const MessageID PARAM_REVERB_HALL = MessageID._(41, _omitEnumNames ? '' : 'PARAM_REVERB_HALL');
  static const MessageID PARAM_REVERB_PLATE = MessageID._(42, _omitEnumNames ? '' : 'PARAM_REVERB_PLATE');
  static const MessageID PARAM_REVERB_SPRING = MessageID._(43, _omitEnumNames ? '' : 'PARAM_REVERB_SPRING');
